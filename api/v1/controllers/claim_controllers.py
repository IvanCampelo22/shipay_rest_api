...
async def create_claim(claim: ClaimCreate, request=Request):
    try: 
        ...
        return await crud.create(args=claim_data_create)
...
async def get_claim(request=Request):
    try:

        return await crud.read(ClaimRead)
...
async def update_claim(claim_id: str, claim: ClaimBase, request=Request):
    try:

        claim_data_update = claim.dict(exclude_unset=True) 
        return await crud.update(claim_id=claim_id, **claim_data_update)
...
async def delete_claim(claim_id: str, request=Request):
    try:
        ...
        return await crud.delete(claim_id=claim_id)
